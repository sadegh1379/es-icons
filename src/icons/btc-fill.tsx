...
const SvgBtcFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="currentColor"
      d="M14.971 12.75h-5.44v2.83h5.44c.95 0 1.73-.64 1.73-1.42s-.78-1.41-1.73-1.41"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      d="M15.621 9.83c0-.66-.62-1.42-1.42-1.42h-4.67v2.83h4.67c.78.01 1.42-.63 1.42-1.41"
    />
  </svg>
);
export default SvgBtcFill;
